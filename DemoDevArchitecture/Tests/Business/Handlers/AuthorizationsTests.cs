using Business.Handlers.Authorizations;
...
namespace Tests.Business.Handlers
{
    ...
    public class AuthorizationsTests
    {
        ...
        private RegisterUserHandler _registerUserCommandHandler;
        ...
        public void Setup()
        {
            ...
            _registerUserCommandHandler = new RegisterUserHandler(_userRepository.Object);
