    ...
    public class TranslateEntityConfiguration : IEntityTypeConfiguration<Translate>
    {
        public void Configure(EntityTypeBuilder<Translate> builder)
        {
            ...
            builder.HasData(
                ...
                new Translate { Id = 37, LangId = 1, Code = "OperationClaimExists", Value = "Bu operasyon izni zaten mevcut." },
                new Translate { Id = 38, LangId = 2, Code = "OperationClaimExists", Value = "This operation permit already exists." },
                new Translate { Id = 39, LangId = 1, Code = "StringLengthMustBeGreaterThanThree", Value = "Lütfen En Az 3 Karakterden Oluşan Bir İfade Girin." },
                new Translate { Id = 40, LangId = 2, Code = "StringLengthMustBeGreaterThanThree", Value = "Please Enter A Phrase Of At Least 3 Characters." },
                new Translate { Id = 41, LangId = 1, Code = "CouldNotBeVerifyCid", Value = "Kimlik No Doğrulanamadı." },
                new Translate { Id = 42, LangId = 2, Code = "CouldNotBeVerifyCid", Value = "Could not be verify Citizen Id" },
                ...
                new Translate { Id = 45, LangId = 1, Code = "AuthorizationsDenied", Value = "Yetkiniz olmayan bir alana girmeye çalıştığınız tespit edildi." },
                new Translate { Id = 46, LangId = 2, Code = "AuthorizationsDenied", Value = "It has been detected that you are trying to enter an area that you do not have authorization." },
                new Translate { Id = 47, LangId = 1, Code = "UserNotFound", Value = "Kimlik Bilgileri Doğrulanamadı. Lütfen Yeni Kayıt Ekranını kullanın." },
                new Translate { Id = 48, LangId = 2, Code = "UserNotFound", Value = "Credentials Could Not Verify. Please use the New Registration Screen." },
                new Translate { Id = 49, LangId = 1, Code = "PasswordError", Value = "Kimlik Bilgileri Doğrulanamadı, Kullanıcı adı ve/veya parola hatalı." },
                new Translate { Id = 50, LangId = 2, Code = "PasswordError", Value = "Credentials Failed to Authenticate, Username and / or password incorrect." },
                new Translate { Id = 51, LangId = 1, Code = "SuccessfulLogin", Value = "Sisteme giriş başarılı." },
                new Translate { Id = 52, LangId = 2, Code = "SuccessfulLogin", Value = "Login to the system is successful." },
                new Translate { Id = 53, LangId = 1, Code = "SendMobileCode", Value = "Lütfen Size SMS Olarak Gönderilen Kodu Girin!" },
                new Translate { Id = 54, LangId = 2, Code = "SendMobileCode", Value = "Please Enter The Code Sent To You By SMS!" },
                new Translate { Id = 55, LangId = 1, Code = "NameAlreadyExist", Value = "Oluşturmaya Çalıştığınız Nesne Zaten Var." },
                new Translate { Id = 56, LangId = 2, Code = "NameAlreadyExist", Value = "The Object You Are Trying To Create Already Exists." },
                new Translate { Id = 57, LangId = 1, Code = "WrongCID", Value = "Vatandaşlık No Sistemimizde Bulunamadı. Lütfen Yeni Kayıt Oluşturun!" },
                new Translate { Id = 58, LangId = 2, Code = "WrongCID", Value = "Citizenship Number Not Found In Our System. Please Create New Registration!" },
                ...
                new Translate { Id = 63, LangId = 1, Code = "PasswordLength", Value = "Minimum 8 Karakter Uzunluğunda Olmalıdır!" },
                new Translate { Id = 64, LangId = 2, Code = "PasswordLength", Value = "Must be at least 8 characters long! " },
                new Translate { Id = 65, LangId = 1, Code = "PasswordUppercaseLetter", Value = "En Az 1 Büyük Harf İçermelidir!" },
                new Translate { Id = 66, LangId = 2, Code = "PasswordUppercaseLetter", Value = "Must Contain At Least 1 Capital Letter!" },
                new Translate { Id = 67, LangId = 1, Code = "PasswordLowercaseLetter", Value = "En Az 1 Küçük Harf İçermelidir!" },
                new Translate { Id = 68, LangId = 2, Code = "PasswordLowercaseLetter", Value = "Must Contain At Least 1 Lowercase Letter!" },
                new Translate { Id = 69, LangId = 1, Code = "PasswordDigit", Value = "En Az 1 Rakam İçermelidir!" },
                new Translate { Id = 70, LangId = 2, Code = "PasswordDigit", Value = "It Must Contain At Least 1 Digit!" },
                new Translate { Id = 71, LangId = 1, Code = "PasswordSpecialCharacter", Value = "En Az 1 Simge İçermelidir!" },
                new Translate { Id = 72, LangId = 2, Code = "PasswordSpecialCharacter", Value = "Must Contain At Least 1 Symbol!" },
                new Translate { Id = 73, LangId = 1, Code = "SendPassword", Value = "Yeni Parolanız E-Posta Adresinize Gönderildi." },
                new Translate { Id = 74, LangId = 2, Code = "SendPassword", Value = "Your new password has been sent to your e-mail address." },
                ...
                new Translate { Id = 77, LangId = 1, Code = "SmsServiceNotFound", Value = "SMS Servisine Ulaşılamıyor." },
                new Translate { Id = 78, LangId = 2, Code = "SmsServiceNotFound", Value = "Unable to Reach SMS Service." },
                new Translate { Id = 79, LangId = 1, Code = "TrueButCellPhone", Value = "Bilgiler doğru. Cep telefonu gerekiyor." },
                new Translate { Id = 80, LangId = 2, Code = "TrueButCellPhone", Value = "The information is correct. Cell phone is required." },
                new Translate { Id = 81, LangId = 1, Code = "TokenProviderException", Value = "Token Provider boş olamaz!" },
                new Translate { Id = 82, LangId = 2, Code = "TokenProviderException", Value = "Token Provider cannot be empty!" },
